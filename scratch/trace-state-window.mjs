...
game._preNhgetchHook = async () => {
    ...
    if (screenIndex >= start && screenIndex <= end) {
        ...
        console.log(JSON.stringify({
            ...
            contextRun: game.context?.run || null,
            runPausedForMore: !!game._run_paused_for_more,
            resumeRunAfterMore: !!game._resume_run_after_more,
            runPausedBeforeEncumberedCheck: !!game._run_paused_before_encumbered_check,
